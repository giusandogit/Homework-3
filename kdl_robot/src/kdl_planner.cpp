...
////////// The steps named in this file are related to HW02, NOT HW03 ////////////////////////////////////
...
{
 int selection_ = 2; // !! REMEMBER TO UNCOMMENT THE RIGHT CONSTRUCTOR IN "kdl_robot_test.cpp" (lines 157, 158)!!
/*
